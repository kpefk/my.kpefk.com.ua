...
export const metadata: Metadata = {
  ...
  description: "MyKPEFK — цифрова платформа для студентів та викладачів КПЕФК ЛНТУ. Розклад занять, електронний кабінет, успішність та керування навчальним процесом онлайн.",
    keywords: [
    "КПЕФК",
    "КПЕФК ЛНТУ",
    "Ковельський коледж",
...
export default function RootLayout({ children }: Readonly<{
  ...
  return (
    <html lang="uk" suppressHydrationWarning className={cn("h-full", "antialiased", firaCode.variable, "font-sans", inter.variable)}>
