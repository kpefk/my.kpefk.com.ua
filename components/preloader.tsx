...
// ── Overlay — зникає з розмиттям вгору ───────────────────────────
const overlayVariants: Variants = {
  visible: { opacity: 1 },
  exit: {
    opacity: 0,
    transition: { duration: 0.5, ease: [0.4, 0, 0.2, 1] }, // cubic-bezier замість рядка
  },
}
      ...
      {visible && (
        ...
        >
          <div className="relative w-[140px] h-[140px]">
            ...
            {/* ── Обідок ───────────────────────────────────────── */}
            <div className="absolute inset-[6px] rounded-[36px] border border-foreground/15 pointer-events-none z-[2]" />

            {/* ── Спінер — конічний градієнт що обертається ────── */}
            <div className="absolute inset-[6px] rounded-[36px] overflow-hidden z-[1]">
              <motion.div
            ...
            <motion.svg
              ...
              animate="visible"
            >
              {/* Маска фону — перекриває спінер всередині заокруглення */}
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d={MASK_PATH}
          ...
          {/* ── Пульсуюче кільце під логотипом ───────────────────── */}
          <motion.div
            className="absolute w-[140px] h-[140px] rounded-[42px] border border-primary/30"
